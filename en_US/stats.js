...
angular.module('splatApp').stats = function ($scope) {
  $scope.stats = {
    ...
    'Special Saved On Death': new Stat("Special Saved (On-Use Death)", function(loadout) {
    ...
    'Main Power Up 1': new Stat("Main Power Up *", function(loadout) {
      ...
      if(loadout.weapon.name.indexOf('Jet Squelcher') != -1) {
        ...
        this.name = "Main Power Up (Bullet Velocity)";      
      }
          ...
          loadout.weapon.name.indexOf('Tri') == -1) 
      {
        ...
        this.name = "Main Power Up (Max Damage Range)";      
      }
      ...
      if(loadout.weapon.name.indexOf('Mini Splatling') != -1) {
        ...
        this.name = "Main Power Up (Burst Duration)";      
      }
      ...
      if(loadout.weapon.name.indexOf('Hydra Splatling') != -1) {
        ...
        this.name = "Main Power Up (Full Charge Min Damage)";      
      }
    ...
    'Main Power Up 2': new Stat("Main Power Up *", function(loadout) {
      ...
      if(loadout.weapon.name.indexOf('Hydra Splatling') != -1) {
        ...
        this.name = "Main Power Up (Full Charge Max Damage)";      
      }
